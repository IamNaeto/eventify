...
const PastEvents = ({ pastEvents = [] }) => {
  ...
  const visibleEvents = showAllEvents ? pastEvents : pastEvents.slice(0, 2);
  ...
  return (
    <main className="grid gap-10 w-full mt-4">
      ...
      <div className="w-full flex items-center justify-between gap-2">
        <h1 className="text-2xl text-[#1E1E1E] font-bold">Past Created Events</h1>
        ...
        >
          {showAllEvents ? 'See Less' : 'See More'} {showAllEvents ? <FiEyeOff className="text-2xl" /> : <FiEye className="text-2xl" />}
        </p>
        )}
