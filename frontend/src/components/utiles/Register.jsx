  ...
  return (
    <main className="grid gap-8 text-[#1E1E1E] min-h-[70vh] w-full relative top-[76px] px-[3%] pb-10 pt-6">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
            <div className="p-4 rounded-lg border border-[#360789] shadow shadow-[#360789]">
              <h1 className="text-base sm:text-lg font-semibold">Event Category</h1>
            ...
            <div className="p-4 rounded-lg border border-[#12B76A] shadow shadow-[#12B76A]">
              <h1 className="text-base sm:text-lg font-semibold">Ticket Type</h1>
        ...
        <p className="text-sm sm:text-base text-[#585858]">{event.event_description}</p>
      </section>

          <div className="w-full grid gap-2 border border-[#C0C0C0] shadow-md p-4 rounded-xl">
            {isRegistered ? (
              <>
                <p className="text-[#3C3C3C] text-sm sm:text-base font-medium">
                  Thank You for Joining. We hope you enjoyed the event! To
                  cancel the event click the button below.
                </p>
                <button
                  onClick={handleCancelRegistration}
                  className="flex items-center justify-center gap-2 text-center text-sm sm:text-base font-bold py-3 px-8 rounded-lg bg-[#E0580C] border-2 border-[#E0580C] text-[#FFF] hover:shadow-md hover:shadow-[#E0580C] transition-transform duration-300 ease-in-out transform hover:scale-90"
                >
                  {loading ? (
